...
main(int argc, char *argv[])
{
  ...
  1d:	6a 04                	push   $0x4
  1f:	e8 36 03 00 00       	call   35a <barrier>
    barrier(4);
  24:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  2b:	e8 2a 03 00 00       	call   35a <barrier>
    barrier(4);
  30:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  37:	e8 1e 03 00 00       	call   35a <barrier>
    wait();
  3c:	e8 79 02 00 00       	call   2ba <wait>
    wait();
  41:	e8 74 02 00 00       	call   2ba <wait>
    wait();
  46:	e8 6f 02 00 00       	call   2ba <wait>
    exit();
  ...
  57:	75 c1                	jne    1a <main+0x1a>
            int pidN = fork();
  59:	e8 4c 02 00 00       	call   2aa <fork>
  5e:	eb ba                	jmp    1a <main+0x1a>
